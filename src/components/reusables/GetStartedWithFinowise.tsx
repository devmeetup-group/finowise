...
const GetStartedWithFinowise = () => {
  return (
    <div className="to-green flex flex-col space-y-16 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-green-800 via-black/95 to-black  px-6 pt-20 pb-28 md:px-12 xl:px-[120px]">
      <div className="h-full w-1/3"></div>
      <div className="mb-6 flex flex-col space-y-2 lg:mb-12 lg:space-y-4">
        <Heading2
          heading="Get started with Finowise"
